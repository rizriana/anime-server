...
import com.secondlab.models.Hero
...
class HeroRepositoryImpl : HeroRepository {
    ...
    private fun calculatePage(page: Int): Map<String, Int?> {
        ...
        // if our page query is between 1..4,
        // then in that case we can increase the next page of add
        if (page in 1..4) {
            nextPage = page.plus(1)
        }
        // if our page query is between 2..5,
        // then in that case we can decrease the next page of add
        if (page in 2..5) {
